...
utils.styles={
    Nube:{color:'gray',text:'🌥️'},
    Corazón:{color:'red',text:'💗'},
    Manzana:{color:'yellow',text:'🍏'},
    Arbol:{color:'green',text:'🌳'},
    Casa:{color:'cyan',text:'🏠'},
    'Simbolo de Pi':{color:'blue',text:'🤓'},
...
/* implementar la funcion para convertir las muestras al formato csv*/
